...
function MissionElementListFlow:init(...)
	CoreEditorEwsDialog.init(self, nil, "Mission List Flow", "", Vector3(300, 150, 0), Vector3(600, 400, 0), "DEFAULT_DIALOG_STYLE,RESIZE_BORDER", ...)
...
function MissionElementListFlow:_on_gui_help()
	local text = [[
Mission flow show connections between different mission components.
