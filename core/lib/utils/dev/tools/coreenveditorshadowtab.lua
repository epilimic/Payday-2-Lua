...
function CoreEnvEditor:create_shadow_tab()
	...
	self._shadow_params.d0 = self:add_post_processors_param("shadow_processor", "shadow_modifier", "d0", SingelSlider:new(self, scrolled_window, "First slice depth start", nil, 1, 10000, 1, 1, true))
	settings_box:add(self._shadow_params.d0._box, 0, 0, "EXPAND")
	self._shadow_params.d1 = self:add_post_processors_param("shadow_processor", "shadow_modifier", "d1", SingelSlider:new(self, scrolled_window, "Second slice depth start", nil, 1, 10000, 1, 1, true))
	settings_box:add(self._shadow_params.d1._box, 0, 0, "EXPAND")
	self._shadow_params.d2 = self:add_post_processors_param("shadow_processor", "shadow_modifier", "d2", SingelSlider:new(self, scrolled_window, "Third slice depth start", nil, 1, 10000, 1, 1, true))
	settings_box:add(self._shadow_params.d2._box, 0, 0, "EXPAND")
	self._shadow_params.d3 = self:add_post_processors_param("shadow_processor", "shadow_modifier", "d3", SingelSlider:new(self, scrolled_window, "Third slice depth end", nil, 1, 50000, 1, 1, true))
	settings_box:add(self._shadow_params.d3._box, 0, 0, "EXPAND")
	self._shadow_params.o1 = self:add_post_processors_param("shadow_processor", "shadow_modifier", "o1", SingelSlider:new(self, scrolled_window, "Blend overlap between first and second shadow slice", nil, 1, 10000, 1, 1, true))
	settings_box:add(self._shadow_params.o1._box, 0, 0, "EXPAND")
	self._shadow_params.o2 = self:add_post_processors_param("shadow_processor", "shadow_modifier", "o2", SingelSlider:new(self, scrolled_window, "Blend overlap between second and third shadow slice", nil, 1, 10000, 1, 1, true))
