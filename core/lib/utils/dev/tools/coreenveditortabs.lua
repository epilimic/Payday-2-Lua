...
function CoreEnvEditor:create_interface()
	...
	self:add_gui_element(gui, "Global illumination", "Global lighting")
	gui = self:add_post_processors_param("deferred", "apply_ambient", "ambient_scale", SingelSlider:new(self, self:get_tab("Global illumination"), "Ambient scale", nil, 0, 10000, 1000, 1000))
	self:add_gui_element(gui, "Global illumination", "Global lighting")
