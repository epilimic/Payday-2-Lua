...
function ToolHub:buildmenu()
	...
	if SystemInfo:platform() == Idstring("WIN32") then
		...
		self._main_frame:connect("4/3", "EVT_COMMAND_MENU_SELECTED", callback(self, self, "change_aspect_ratio"), 1.3333334)
		self._main_frame:connect("16/9", "EVT_COMMAND_MENU_SELECTED", callback(self, self, "change_aspect_ratio"), 1.7777778)
