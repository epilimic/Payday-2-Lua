...
function EnemyPreferedAddUnitElement:remove_unit_list_btn()
	local function f(unit)
		return (not self._hed.spawn_groups or not table.contains(self._hed.spawn_groups, unit:unit_data().unit_id)) and self._hed.spawn_points and table.contains(self._hed.spawn_points, unit:unit_data().unit_id)
	end
