...
function EquipmentUnitElement:_build_panel(panel, panel_sizer)
	...
	self:_build_value_number(panel, panel_sizer, "amount", {floats = 0, min = 1}, "Specifies how many of this equipment to recieve (only work on those who has a max_amount set in their tweak data).")
end
