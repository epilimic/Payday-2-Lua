...
function InteractionUnitElement:_build_panel(panel, panel_sizer)
	...
	self:_build_value_number(panel, panel_sizer, "override_timer", {floats = 1, min = -1}, "Can be used to override the interaction time specified in tweak data. -1 means that it should not override.")
