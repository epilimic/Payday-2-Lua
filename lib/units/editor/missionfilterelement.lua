...
function MissionFilterUnitElement:_build_panel(panel, panel_sizer)
	...
	var_2:connect("EVT_COMMAND_CHECKBOX_CLICKED", callback(self, self, "set_element_data"), {ctrlr = var_2, value = 2})
	panel_sizer:add(var_2, 0, 0, "EXPAND")
	local var_3 = EWS:CheckBox(panel, "Mission filter 3", "")
	var_3:set_value(self._hed[3])
	var_3:connect("EVT_COMMAND_CHECKBOX_CLICKED", callback(self, self, "set_element_data"), {ctrlr = var_3, value = 3})
	panel_sizer:add(var_3, 0, 0, "EXPAND")
	local var_4 = EWS:CheckBox(panel, "Mission filter 4", "")
	var_4:set_value(self._hed[4])
	var_4:connect("EVT_COMMAND_CHECKBOX_CLICKED", callback(self, self, "set_element_data"), {ctrlr = var_4, value = 4})
	panel_sizer:add(var_4, 0, 0, "EXPAND")
	local var_5 = EWS:CheckBox(panel, "Mission filter 5", "")
	var_5:set_value(self._hed[5])
	var_5:connect("EVT_COMMAND_CHECKBOX_CLICKED", callback(self, self, "set_element_data"), {ctrlr = var_5, value = 5})
