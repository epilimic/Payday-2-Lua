...
function SecurityCameraUnitElement:_build_panel(panel, panel_sizer)
	...
	yaw:connect("EVT_COMMAND_TEXT_ENTER", callback(self, self, "set_element_data"), {ctrlr = yaw, value = "yaw"})
	yaw:connect("EVT_KILL_FOCUS", callback(self, self, "set_element_data"), {ctrlr = yaw, value = "yaw"})
	local pitch_params = {
		name = "Pitch:",
		panel = panel,
		sizer = panel_sizer,
	...
	pitch:connect("EVT_COMMAND_TEXT_ENTER", callback(self, self, "set_element_data"), {ctrlr = pitch, value = "pitch"})
	pitch:connect("EVT_KILL_FOCUS", callback(self, self, "set_element_data"), {ctrlr = pitch, value = "pitch"})
	local fov_params = {
		name = "FOV:",
		panel = panel,
		sizer = panel_sizer,
	...
	fov:connect("EVT_COMMAND_TEXT_ENTER", callback(self, self, "set_element_data"), {ctrlr = fov, value = "fov"})
	fov:connect("EVT_KILL_FOCUS", callback(self, self, "set_element_data"), {ctrlr = fov, value = "fov"})
