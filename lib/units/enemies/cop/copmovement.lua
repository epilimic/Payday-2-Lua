...
function CopMovement:_add_attention_destroy_listener(attention)
	if attention and attention.unit then
		local listener_class = (not attention.unit:base() or not attention.unit:base().add_destroy_listener or not attention.unit:base()) and attention.unit:unit_data() and attention.unit:unit_data().add_destroy_listener and attention.unit:unit_data()
...
function CopMovement:_remove_attention_destroy_listener(attention)
	if attention and attention.destroy_listener_key then
		...
		local listener_class = (not attention.unit:base() or not attention.unit:base().remove_destroy_listener or not attention.unit:base()) and attention.unit:unit_data() and attention.unit:unit_data().remove_destroy_listener and attention.unit:unit_data()
