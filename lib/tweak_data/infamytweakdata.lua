...
function InfamyTweakData:init()
	...
	self.items.infamy_root = {
		...
		desc_params = {cashcost = skillcost_readable_multiplier, xpboost = infamous_readable_xp_multiplier_base},
		icon_xy = {0, 0},
		cost = self.cost.root,
		upgrades = {
			{
	...
	self.items.infamy_mastermind = {
		...
		desc_params = {multibasic = skilltree_readable_multiplier, xpboost = infamous_readable_xp_multiplier_base},
		icon_xy = {2, 0},
