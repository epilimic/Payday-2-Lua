...
function VoteManager:option_vote_kick()
	return game_state_machine:current_state_name() ~= "menu_main" and game_state_machine:current_state_name()
end
function VoteManager:option_host_kick()
	return game_state_machine:current_state_name() == "menu_main" or game_state_machine:current_state_name()
end
